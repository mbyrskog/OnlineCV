  ...
  return (
    <Box>
      ...
      <Typography gutterBottom>
        ...
        <br />
        <br /> Before transitioning into tech, I worked with electrical
        installations on construction sites - a role that taught me the
        importance of structure, precision, and efficiency. These values still
        influence how I approach software development and problem-solving today.
        Feel free to explore the site to learn more about my skills, background,
        and projects.
      </Typography>
    </Box>
  );
